...
const Features = () => {
    return (
      <div>
            <HeaderComponent/>
                <div className="d-sm-flex justify-content-center container">
              <Row>
                <Col md={4} className="mb-4">
                  <Card className="bg-info rounded-5 p-2 border-0 shadow text-white m-1" style={{ height: "400px" }}>
                    <Card.Img
                    ...
                    <Card.Body className="d-flex flex-column justify-content-between">
                      <div>
                        <Card.Title className="fw-bold">Youth</Card.Title>
                        <hr/>
                        <Card.Text>
                ...
                <Col md={4} className="mb-4">
                  <Card className="bg-info border-0 rounded-5 p-2 shadow text-white m-1" style={{ height: "400px" }}>
                    <Card.Img
                  ...
                  <Card className="bg-info border-0 rounded-5 p-2 shadow text-white m-1" style={{ height: "400px" }}>
                    ...
                    <Card.Body className="d-flex flex-column justify-content-between">
                      <div>
                        ...
                        <hr/>
                        <Card.Text>
                          We offer financial advice to low-income earners
                        </Card.Text>
                      </div>
                    </Card.Body>
                  </Card>
                ...
                <Col md={4} className="mb-4">
                  <Card className="bg-info border-0 rounded-5 p-2 shadow text-white m-1" style={{ height: "400px" }}>
                    ...
                    <Card.Body className="d-flex flex-column justify-content-between">
                      <div>
                        <Card.Title className="fw-bold">Rural & Marginalized Communities</Card.Title>
                        <hr/>
                        <Card.Text>
                ...
                <Col md={4} className="mb-4">
                  <Card className="bg-info border-0 rounded-5 p-2 shadow text-white m-1" style={{ height: "400px" }}>
                    ...
                    <Card.Body className="d-flex flex-column justify-content-between">
                      <div>
                        <Card.Title className="fw-bold">Free Peer Support</Card.Title>
                        <hr/>
                        <Card.Text>
                ...
                <Col md={4} className="mb-4">
                  <Card className="bg-info border-0 rounded-5 p-2 shadow text-white m-1" style={{ height: "400px" }}>
                    ...
                    <Card.Body className="d-flex flex-column justify-content-between">
                      <div>
                        <Card.Title className="fw-bold">Mental Health Support</Card.Title>
                        <hr/>
                        <Card.Text>
                ...
                <Col md={4} className="mb-4">
                  <Card className="bg-info border-0 rounded-5 p-2 shadow text-white m-1" style={{ height: "400px" }}>
                    ...
                    <Card.Body className="d-flex flex-column justify-content-between">
                      <div>
                        <Card.Title className="fw-bold">Education and Training</Card.Title>
                        <hr/>
                        <Card.Text>
                ...
                <Col md={4} className="mb-4">
                  <Card className="bg-info border-0 rounded-5 p-2 shadow text-white m-1" style={{ height: "400px" }}>
                    ...
                    <Card.Body className="d-flex flex-column justify-content-between">
                      <div>
                        <Card.Title className="fw-bold">Employment Opportunities</Card.Title>
                        <hr/>
                        <Card.Text>
